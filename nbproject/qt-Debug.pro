...
PKGCONFIG +=
QT = core gui opengl
SOURCES += MainWindow.cpp main.cpp PosixClient.cpp reqMktDataGUI.cpp
HEADERS += ui_reqMktDataGUI.h PosixClient.h MainWindow.h reqMktDataGUI.h ui_MainWindow.h
